...
const jogos = [
  { data: '2025-07-31', equipa1_golos: 8, equipa2_golos: 9, equipa1: ['Ismael Campos', 'Joaquim Rocha', 'João Couto', 'Nuno Ferreira', 'Rogério Silva'], equipa2: ['Carlos Correia', 'João Couto', 'Ricardo Sousa', 'Rui', 'Valter Pinho'] },
  ...
  { data: '2025-07-03', equipa1_golos: 8, equipa2_golos: 7, equipa1: ['Joel Almeida', 'João Couto', 'Leonardo Sousa', 'Paulo Pinto', 'Rui'], equipa2: ['Carlos Correia', 'Césaro Cruz', 'Flávio Silva', 'Ismael Campos', 'Rogério Silva'] },
  ...
  { data: '2025-06-12', equipa1_golos: 4, equipa2_golos: 18, equipa1: ['Flávio Silva', 'Nuno Ferreira', 'Pedro Lopes', 'Rogério Silva', 'Rui'], equipa2: ['Carlos Correia', 'Césaro Cruz', 'Joel Almeida', 'João Couto', 'Valter Pinho'] },
  { data: '2025-06-05', equipa1_golos: 13, equipa2_golos: 7, equipa1: ['Flávio Silva', 'Joel Almeida', 'Nuno Ferreira', 'Pedro Lopes', 'Rogério Silva'], equipa2: ['Carlos Correia', 'Césaro Cruz', 'João Couto', 'Rui', 'Valter Pinho'] },
  ...
  { data: '2025-05-22', equipa1_golos: 5, equipa2_golos: 2, equipa1: ['Carlos Silva', 'Césaro Cruz', 'Ismael Campos', 'Nuno Ferreira', 'Rui'], equipa2: ['Carlos Correia', 'Flávio Silva', 'Joaquim Rocha', 'Pedro Lopes', 'Rogério Silva'] },
